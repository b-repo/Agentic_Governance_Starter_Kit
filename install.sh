...
echo "Next steps:"
echo "1) Inventory supplied scope files in docs/SCOPE_INTAKE.md"
echo "2) Resolve blocking scope questions before implementation"
echo "3) Decompose the full scope into docs/ISSUE_LEDGER.json"
echo "4) Run: python scripts/governance/sync_issue_ledger.py --audit --report"
echo "5) Run: python scripts/governance/sync_issue_ledger.py --repo owner/repo --dry-run"
echo "6) Run: python scripts/governance/sync_issue_ledger.py --repo owner/repo --apply"
echo "7) Run: python scripts/governance/sync_issue_ledger.py --repo owner/repo --health-check"
